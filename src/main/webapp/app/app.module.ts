...
import { BudenzauberCoreModule } from 'app/core';
import { BudenzauberAppRoutingModule } from './app-routing.module';
...
export class BudenzauberAppModule {
