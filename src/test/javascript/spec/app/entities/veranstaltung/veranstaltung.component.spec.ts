...
import { VeranstaltungComponent } from 'app/entities/veranstaltung/veranstaltung.component';
...
describe('Component Tests', () => {
    describe('Veranstaltung Management Component', () => {
        let comp: VeranstaltungComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VeranstaltungComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.veranstaltungs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
